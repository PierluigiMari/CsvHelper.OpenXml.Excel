...
public class GenericPersonMapExport : ClassMap<GenericPerson>
{
    public GenericPersonMapExport()
    {
        ...
        Map(x => x.DateTimeOffsetDefault).Data.TypeConverterOptions = new ExcelTypeConverterOptions { ExcelCellFormat = ExcelCellFormats.Text };
        //Map(m => m.DateTimeOffsetDefault).TypeConverter(new ExcelDateTimeOffsetConverter(DateTimeKind.Utc)).Data.TypeConverterOptions = new ExcelTypeConverterOptions { ExcelCellFormat = ExcelCellFormats.DateTimeWithHoursMinutes };
        //Map(m => m.DateTimeOffsetDefault).TypeConverter(new ExcelDateTimeOffsetConverter(DateTimeKind.Unspecified)).Data.TypeConverterOptions = new ExcelTypeConverterOptions { ExcelCellFormat = ExcelCellFormats.DateTimeWithHoursMinutesSecondsDefault };
